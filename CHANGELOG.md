...
[更改] 版本号 0.2.3-alpha.1，versionCode 386

[添加] 支持 RSS / Atom 订阅、文章阅读与订阅源管理

[添加] 支持原地长按选择文字与快捷工具栏，头像展示装扮和身份标记

[修复] 修复视频全屏触控、评论交互与风控提示，改善弹幕缩放和折叠屏布局

[修复] 修复动态图片布局，优化视频详情转场

[更改] 交互时请求高刷新率，空闲后请求回落至 60Hz
